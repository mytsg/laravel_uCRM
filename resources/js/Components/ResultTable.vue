...
<template>
    <div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            ...
            <tbody>
                <tr v-for="item in props.data.data" :key="item.date" class="border border-b-2 border-gray-100">
    ...
    <div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">構成比</th>
            ...
            <tbody>
                <tr v-for="item in data.data" :key="item.date" class="border border-b-2 border-gray-100">
    ...
    <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        ...
        <div class="my-4 text-center text-xl">合計: {{ data.totals }}人</div>
        <h3 class="my-4 text-center text-2xl">RFMランクごとの人数</h3>
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
        ...
        <h3 class="my-4 text-center text-2xl">RとFの集計表</h3>
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
